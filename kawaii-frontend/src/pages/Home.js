...
const HomePage = () => {
	...
	return (
		...
		<div className="fixed flex top-4 right-4 z-50">
			<a href="javascript:;" class="p-2 rounded-lg flex items-center justify-center transition-all duration-500 hover:border-gray-100 hover:bg-gray-100 bg-blue-600 text-white hover:bg-blue-700">
